<template>
  ...
  <div
    class="grid bg-black/5 dark:bg-black/10 shadow-sm sm:px-2 px-8 py-2"
  ...
  >
    ...
    <div class="">
      ...
      >
        <li>
          <NuxtLink to="/interests" class="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="2em"
              height="2em"
        ...
        <li>
          <NuxtLink to="/skills" class="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="2em"
              height="2em"
        ...
        <li>
          <NuxtLink to="/cv" class="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="2em"
              height="2em"
